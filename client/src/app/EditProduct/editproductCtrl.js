    ...
    function($scope, $rootScope, $http, $location, growl, $modal, $routeParams, $filter, blockUI, $q, uiGridConstants, $timeout, $interval, getProductData) {
        ...
        var init = function() {
            ...
            $q.all([getProductData.getProducts($routeParams.id)
                    ...
                    }), getProductData.getAttribute("").then(function(info) {
        ...
        $scope.gridOptions = {
            ...
            columnDefs: [{
                ...
                editableCellTemplate: $scope.template1,
                enableCellEdit: true,
                filter: {
                ...
                filter: {
                    ...
                    selectOptions: [{
                        ...
                        label: '250 Translation needed',
                        value: '250'
                    }, {
                        label: '275 Translation in progress',
                        value: '275'
                    }, {
                        label: '300 waiting',
                        value: '300'
                ...
                editDropdownOptionsArray: [{
                        ...
                        status: '225 translate',
                        id: '225'
                    }, {
                        status: '250 Translation needed',
                        id: '250'
                    }, {
                        status: '275 Translation in progress',
                        id: '275'
                    }, {
                        status: '300 waiting',
                        id: '300'
                    }, {
                        status: '350 translate ',
                        id: '350'
                    }, {
                        status: '400 confirmed',
                        id: '400'
                    }, {
                        status: '420 Immediate',
                        id: '420'
                    }, {
                        status: '700 temporary',
                        id: '700'
                    }, {
                        status: '800 deleted',
                        id: '800'
                ...
                displayName: "Section",
                field: 'sectionRef.attributeSectionId',
                filter: {
...
var ModalInstanceCtrl = function($scope, $modalInstance, $http, $location) {
    ...
    //         })
    // }
    $scope.searchClassification = function(rqstData) {

        $http.post('/api/classificationSearch', rqstData)
            .then(function(result) {
...
var ClassificationGroupCtrl = function($scope, $modalInstance, $http, $location, cid_detail) {
    ...
    var postClassificationGroup = function(cid) {
        $http.post('/api/classificationGroupSearch', cid)
            .then(function(result) {
...
var AttributeCtrl = function($scope, $modalInstance, $http, $location, $modal) {
    $scope.searchAttribute = function(rqstData) {
        $http.post('/api/attributeSearch', rqstData)
            .then(function(result) {
...
var AttributeSectionCtrl = function($scope, $modalInstance, $http, $location) {
    ...
    var postSection = function(rqstData) {
        $http.post('/api/attributeSectionSearch', rqstData)
            .then(function(result) {
